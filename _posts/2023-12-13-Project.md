...
Finally to measure the results in the next sections the author is creating some functions to it. This codes run the model inside and provide with the results of RMSE, R square, Out of the Bag score (related to the decision tree)
